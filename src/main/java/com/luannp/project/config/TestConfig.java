package com.luannp.project.config;
...
import com.luannp.project.entities.Payment;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(null, "Johnny B.", "johnny@email.com", "988888888", "123456");
		User u2 = new User(null, "Jay Kyle", "jay@email.com", "977777777", "123456");
